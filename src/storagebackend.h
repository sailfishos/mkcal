...
public:
    ...
    */
    ...
    /**
      ...
      @return True on success, false otherwise.
     */
    bool storeIncidences(const Collection &additions,
    ...
    /**
      ...
      @return True on success, false otherwise.
     */
    bool storeIncidences(const SharedCollection &additions,
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
          ...
          @param defaultNotebookId is the UID of the default notebook.
        */
        virtual void newNotebooks(StorageBackend *storage,
                                  const Library &notebooks,
    ...
    /**
      ...
      @param manager is a pointer to the current manager.
...
protected:
    ...
    void newNotebooks(const Library &notebooks, const QString &defaultNotebookId);
